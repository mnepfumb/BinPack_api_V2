...
export default function ActivateUserDialog({ user }) {
  ...
  function handleClose() {
	...
	const handleAactivate = async (event) => {
  ...
  return (
    <div>
      ...
      <Icon style={{ color: '#08ad6c' }} onClick={handleClickOpen}>
        do_not_disturb_on
      </Icon>
      <Dialog
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={handleAactivate} color="primary">
            Deactivate
          </Button>
        </DialogActions>
      </Dialog>
