...
const UserTable = () => {
  ...
  const onClick = () => navigate('/netcare/admin/user-add-form');
            ...
            <TableBody>
              {users.map((user, index) => (
                <TableRow key={index} hover>
                  ...
                  <TableCell sx={{ px: 0, textTransform: 'capitalize'  }} align="left" colSpan={4}>
                    {user.role}
                  </TableCell>
                  ...
                  <TableCell sx={{ px: 0 }} colSpan={4}>
                    <IconButton>
                      <Icon
                        ...
                        state={{ user }}
                        component={Link}
                        to={{ pathname: '/netcare/admin/user-edit-form', state: user }}
                      >
                        edit
                      </Icon>
                    </IconButton>
