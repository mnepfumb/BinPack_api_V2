...
const RejectedRequisitionsCards = () => {
		...
		<Grid container  sx={{ mb: '24px', mt: 2 }} sm={12}  style={{ gap: 15 }}>
			{requisitions.map((requisition, index) => (
				<Grid requisition xs={12} md={3} key={index}>
					<Link state={{ requisition: requisition }} to={{ pathname: '/netcare/service_provider/view-completed-requisitions-details', state: requisition }}>
...
export default RejectedRequisitionsCards;
